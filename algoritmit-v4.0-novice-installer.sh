...
INSTALL_DIR="$HOME/algoritmit-v4.0-trading-bot"
BACKUP_DIR="$HOME/algoritmit-v4.0-backup-$(date +%Y%m%d-%H%M%S)"
...
handle_error() {
    ...
    log_info "4. Try running: curl -fsSL $GITHUB_REPO/raw/main/algoritmit-v4.0-novice-installer.sh | bash"
    ...
    cat > package.json << 'EOF'
{
  ...
  "repository": {
    "type": "git",
    "url": "https://github.com/your-username/worldchain-trading-bot.git"
  }
}
EOF
...
For help and updates: https://github.com/your-username/worldchain-trading-bot
EOF
...
post_installation_setup() {
    ...
    echo ""
    echo "3. Start the v4.0 bot:"
    echo "   npm start"
    echo ""
    echo "4. Run v4.0 setup wizard:"
    echo "   npm run setup"
    echo ""
    echo "5. Enable ultra-fast mode:"
...
EOF
    ...
    log_header "🚀 STARTING ALGORITMIT v4.0 INSTALLATION PROCESS"
    ...
    echo -e "${YELLOW}Press Enter to continue with v4.0 installation, or Ctrl+C to cancel...${NC}"
    read -r
